...
## VisionBridge introduces Context-Aware Audio Description.
...
Only if the answer is **yes** does VisionBridge generate a description.
...
VisionBridge downloads the video, extracts the transcript, analyzes the visual content, and prepares an audio-description timeline before playback begins.
...
VisionBridge pauses playback, extracts the current frame, asks Gemma, speaks the answer, and resumes automatically.
...
VisionBridge follows one principle.
...
Otherwise VisionBridge should remain silent.
...
The instructor's narration should **never** overlap with VisionBridge.
...
This separation between **deciding** and **describing** is the most important intelligence in VisionBridge.
...
VisionBridge also functions as an AI assistant.
...
### Scene 2 — VisionBridge (40 seconds)

Paste the same URL into VisionBridge.
